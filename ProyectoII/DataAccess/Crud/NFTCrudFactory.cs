...
namespace DataAcess.Crud
{
    public class NFTCrudFactory : CrudFactory
    {
        ...
        public override NFT Retrieve<NFT>(BaseEntity entity)
        {
            ...
            if (lstResult.Count > 0)
            {
                ...
                return (NFT)Convert.ChangeType(objs, typeof(NFT));
            }

            return default(NFT);
        }

        public override List<NFT> RetrieveAll<NFT>()
        {
            var list = new List<NFT>();
            ...
            if (lstResult.Count > 0)
            {
                ...
                {
                    list.Add((NFT)Convert.ChangeType(c, typeof(NFT)));
                }
            }
